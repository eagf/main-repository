...
<body>
    ...
    <div>
        <form action="gegevensOpvragen.php?action=besteld" method="post">
            ...
            <input type="datetime-local" id="dag" name="dag" value="<?php print(date('Y-m-d\TH:i', strtotime('+30 minutes'))); ?>" min="<?php print(date('Y-m-d\TH:i', strtotime('+30 minutes'))); ?>" required><br><br>
