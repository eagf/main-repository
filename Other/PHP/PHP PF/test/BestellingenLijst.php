...
class BestellingenLijst
{
    ...
    {
        $sql = "select bestelID, broodjes.ID as broodjeID, klanten.klantID, afhalingsmoment, statussen.statusID, Naam, Omschrijving, Prijs, voornaam, achternaam, email, Status
        from broodjes, klanten, statussen, bestellingen 
        where bestellingen.broodjeID = broodjes.ID and bestellingen.klantID = klanten.klantID and bestellingen.statusID = statussen.statusID
        order by afhalingsmoment";
