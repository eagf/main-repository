...
{
    public function create(int $klantid, int $broodjeid, array $belegSoorten, int $valseTijd, float $totaalprijs)
    {
        try {
            ...
            $dbh = $this->db_connect();
            $sql = "INSERT INTO bestellingen (klantid, datumtijd, totaalprijs) VALUES (:klantid, :datumtijd, :totaalprijs)";
    ...
    public function getBestellingenByKlantId(int $klantid): ?array
    {
        try {
            ...
            foreach ($resultSet as $rij) {
                $beleg = new Bestelling((int) $rij["bestelid"], (int) $rij["klantid"], $rij["datumtijd"], (float) $rij["totaalprijs"]);
